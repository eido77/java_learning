...
class Person1{
    ...
    //同一个类里的方法可以互相调用,不需要写在彼此内部。这里是调用 sleep 方法,不是定义它，定义在下面第79行
        sleep(8);
    }
    public void sleep(int hour) {
    ...
    public void interests(String hobby) {
        System.out.println("interests" + hobby);
    }
    public String interests1(String hobby) {
        String info = "interests1" + hobby;
    ...
    //一个文件里有两个 main，你点哪个三角，就只跑哪个。
    public static void main(String[] args) {
        Person1 p2 = new Person1();
        p2.printNumber(10); // 0 1 2 3
    }
}
