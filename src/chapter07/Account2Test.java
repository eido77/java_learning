...
public class Account2Test {
   ...
   （2）父类Account2的属性balance被设置为private，但在子类CheckAccount2的withdraw方法中需要修改它的值，
    ...
    public static void main(String[] args) {
        Account2 account2 = new Account2(1122, 20000, 0.045);
        account2.withdraw(30000); // 余额不足！
        System.out.println("您的账户余额为：" + account2.getBalance());

        account2.withdraw(2500);
        account2.deposit(3000);
        System.out.println("您的账户余额为：" + account2.getBalance());
        System.out.println("月利率为：" + account2.getMonthlyInterestRate());
