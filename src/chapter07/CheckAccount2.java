...
public class CheckAccount2 extends Account2 {
    /*
   ...
   （2）父类Account2的属性balance被设置为private，但在子类CheckAccount2的withdraw方法中需要修改它的值，
    ...
    public CheckAccount2(int id, double balance, double annualInterestRate) {
        super(id, balance, annualInterestRate);
    }

    public CheckAccount2(int id, double balance, double annualInterestRate, double overdraft) {
        super(id, balance, annualInterestRate);
...
//            getBalance() = getBalance() -amount;
            // setBalance(getBalance() - amount); // 也可以
